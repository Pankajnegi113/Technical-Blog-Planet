                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group ">
                            <a href="#" onclick="getPosts(0,this)"  class="bg-dark c-link list-group-item list-group-item-action active">
                                All Posts
                            </a>
		...
		$('#add-post-form').on('submit',function(e){
			...
			$.ajax({
				...
				success: function(data){	
					debugger;
					swal("Congratulations!","New post posted to planet","success");
...
<script>
	...
	function getPosts(catId,current){
		$('#loader').show();
		$('#post-container').hide();
		...
		$.ajax({
			...
			success: function(data){
				...
				$(current).addClass('active bg-dark');
			},
			error:{
