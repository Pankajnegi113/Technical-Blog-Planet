<%@page import="com.blogger.entities.User" %>
...
<%@page import="com.blogger.entities.Category" %>
<%
...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="index.jsp"><span class="fa fa-certificate"></span> Technical Planet</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index.jsp">Blogs By Pankaj <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><span class="fa fa-address-book"> Contact</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#post-modal" ><span class="fa fa-address-book">Post To Planet</span></a>
      </li>
    ...
    <ul class="navbar-nav mr-right bg-dark">
    	<li class="nav-item">
            ...
            <div class="container">
                <div class="row mt-4">
                    ...
                    <div class="col-md-9">
                		...
                		<div class="card-body">
                				<h3 class="display-3"><%=post.getpTitle() %></h3>
                				<hr>
                				<p><%=post.getpContent() %></p>
                				<pre><%=post.getpCode() %></pre>
                		</div>
                        <div class="footer bg-dark text-center p-2">
                        <%-- 	<a href="#!" onclick="doLike(<%= post.getpId()%>,<%= post.getId()%>)" class="btn btn-outline-light btn-sm"> <i class="fa fa-thumbs-o-up"></i> <span class="like-counter"><%= ld.countLikeOnPost(p.getPid())%></span></a> --%>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header bg-dark text-white">
	        <h5 class="modal-title mb-2" id="exampleModalLabel">Developed By Blogger, Pankaj</h5>
	      ...
	      <div class="modal-body">
	        <div class="container text-center">
	        	<img src="avatar/<%=user.getProfile()%>" height="100px" style="border-radius:50%;max-width:"100px"">
	        	<h5 class="modal-title"><%=user.getName()%></h5>
	        	<table class="table mt-2" id="details-table">
				  <tbody>
				    <tr>
				      <th scope="row">ID</th>
				      <td><%=user.getId() %></td>
			  ...
			  <div id="edit-table" style="display:none">
				...
				<h3 class="display-6">Edit details</h3>
					...
					<tbody>
					    ...
					    <tr>
					      <th scope="row">Gender</th>
					      <td><input type="text" name="gender" class="form-control" value="<%=user.getGender()%>"></td>
					    </tr>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" id="edit-btn" class="btn bg-dark text-white">Edit</button>
	      </div>
	    </div>
	  </div>
	</div>
...
<div class="modal fade" id="post-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn bg-dark text-white">Save changes</button>
      </div>
    </div>
  </div>
</div>
